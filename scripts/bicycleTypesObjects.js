const bicycleTypesObjects = [
  {
    ...
    imageLeft: 'url(../images/highway.jpg)',
    imageRight: 'url(../images/gravel.jpg)',
    icon: 'url(../icons/highway-vector.svg)',
  },
  {
    title: 'Грэвел',
    ...
    imageLeft: 'url(../images/gravel.jpg)',
    imageRight: 'url(../images/tt.jpg)',
    icon: 'url(../icons/gravel-vector.svg)',
  },
  {
    title: 'ТТ',
    ...
    imageLeft: 'url(../images/tt.jpg)',
    imageRight: 'url(../images/highway.jpg)',
    icon: 'url(../icons/tt-vector.svg)',
  },
];
